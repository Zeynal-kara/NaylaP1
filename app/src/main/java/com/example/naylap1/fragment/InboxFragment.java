...
public class InboxFragment extends Fragment {
    ...
    public void onStart() {
        ...
        InboxRecyclerViewAdaper inboxRecyclerViewAdaper = new InboxRecyclerViewAdaper(loadList(),
                new InboxRecyclerViewAdaper.OnItemClickListener() {
            ...
            public void onItemClick(InboxMessage inboxMessage, int position) {
                ...
                ( (InboxRecyclerViewAdaper)(recyclerView.getAdapter()) ).setItemRead(position);


            }
        });

        recyclerView.setAdapter(inboxRecyclerViewAdaper);
